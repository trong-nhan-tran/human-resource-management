...
<body>
    ...
    <div class="">
        ...
        // Tạo chuỗi tên sql chứa lệnh SQL
        $sql = "SELECT * FROM `giao_vien` ORDER BY `MAGV` ";
        // Kết nối chuỗi sql_them vào CSDL
        $sql_them = mysqli_query($connect, $sql);
        ?>
        <div>
            ...
            <div>
                ...
                <table class="table table-bordered mt-24">
                    ...
                    <tbody>
                        <?php
                        $i = 0;
                        while ($row = mysqli_fetch_array($sql_them)) {
                            $i++;
                        ?>
                            <tr>
                                <td><?php echo $i ?></td>
                                ...
                                <td><?php echo $row['MATDHV'] ?></td>
                                <td><?php echo $row['MAHANGGV'] ?></td>
                                <td><?php echo $row['MABAC'] ?></td>
                                <td>
